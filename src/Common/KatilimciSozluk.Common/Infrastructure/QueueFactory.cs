...
namespace KatilimciSozluk.Common.Infrastructure
{
    public static class QueueFactory
    {
        ...
        {
            var factory = new ConnectionFactory() { HostName = KatilimciSozlukConstants.RabbitMQHost };
        ...
        public static EventingBasicConsumer EnsureExchange(this EventingBasicConsumer consumer, string exchangeName, string exchangeType = KatilimciSozlukConstants.DefaultExchangeType)
        {
